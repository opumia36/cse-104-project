...
double price[7] = {50.00 , 50.00 , 40.00 , 40.00 , 36.00 , 60.00 , 70.00 };
...
void printMeals()
{
      ...
      printf("\20*******************  WELCOME TO OPU RESTURANT **************************\20\n");
      printf(" \t\t\t Below is the menue:\20\n");
      printf(" \t\t\t MEALS\t\t\tPRICE:\n");
      printf(" \t\t\t \22*******************************\22\n");
      printf(" \t\t\t 1- Fish and Chips\t50.00\n");
      printf(" \t\t\t 2- Spaghetti\t\t50.00tk\n");
      printf(" \t\t\t 3- T-Bone Steak\t40.00tk\n");
      printf(" \t\t\t 4- Chicken Chop\t40.00tk\n");
      printf(" \t\t\t 5- Chicken Maryland\t36.00tk\n");
      printf(" \t\t\t 6- Red Lobster\t\t60.00\n");
      printf(" \t\t\t 7- Seafood Platter\t70.00tk\n");
